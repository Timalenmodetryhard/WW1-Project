...
<<<<<<< Updated upstream
    ...
    <div class="poppy">
        <article class="article-img">
            <div class="article-img-ratio"></div>
            <picture>
                <source srcset="img/flower/poppy.png" sizes="(min-width: 523px) 594px, (min-width: 523px) calc((100vw - 136px) * 0.5 - 24px), (min-width: 523px) calc((100vw - 64px) * 0.5 - 16px), (min-width: 523px) calc(100vw - 80px), calc(100vw - 32px)" type="image/png">
                <img src="img/flower/poppy.png" width="1920" height="2181" alt="Poppy">
            </picture>
        </article>
...
<?php
    ...
    include __DIR__ . "\layout\donation.php";
?>
=======
<?php 
